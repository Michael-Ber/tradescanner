...
gulp.task("clean-img", () => {
  return deleteAsync(['./dist/assets/img', './src/assets/img/webp'])
})
...
gulp.task("watch", () => {
  ...
  gulp.watch("./src/assets/img/**/**.{jpg,jpeg,png,svg}", gulp.series("clean-img","images"));
  gulp.watch("./src/assets/img/**/**.{jpg,jpeg,png}", gulp.series("clean-img","webp"));
});
